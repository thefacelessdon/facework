...
echo ""
"$SCRIPT_DIR/bin/facework-doctor"
echo ""
...
echo "  └─────────────────────────────────────────────────┘"
echo ""
echo "  1. If Claude Code is already running, quit and reopen it."
echo "     Skills only load when a session starts."
echo ""
echo "  2. Open your project directory and start Claude Code:"
echo ""
echo "     cd ~/projects/your-project"
echo "     claude"
echo ""
echo "  3. Type /fw-semantics to begin Phase 1."
echo ""
echo "  If the slash command doesn't appear, restart Claude Code."
echo ""
echo "  ─────────────────────────────────────────────────────"
echo ""
echo "  All phases:"
