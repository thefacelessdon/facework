...
## 3. INFORMATION ARCHITECTURE — Layered Public Narrative

The previous IA treated Facework mostly as a single public object: "the
protocol." The repo's doctrine is now clearer than that. Publicly, the site
needs to distinguish four layers without making the experience academic:

1. **Theory** — why systems cohere or decay
2. **Discipline** — how coherent systems are designed
3. **Practice** — how Facework applies that discipline
4. **Proof** — where the work demonstrates itself in the world

The job of the IA is not to expose every internal document. Its job is to help
the right visitor understand, in the right order:

- what Facework sees
- what Facework knows
- what Facework does
- what Facework has proven
- how to engage

### IA Principle

**Do not collapse worldview, method, and offer into one page-level object.**

That collapse makes Facework feel either too abstract ("theory posing as a
service") or too tactical ("service site with some philosophy attached"). The
site should instead reveal a ladder:

```
The Physics  →  The Discipline  →  The Practice  →  The Proof  →  Engage
```

### Recommended public navigation

Keep the number of top-level choices low. The nav should separate the system
without over-explaining it.

| Label | Purpose | Current URL |
|------|---------|-------------|
| **System** | The worldview + discipline + protocol stack | `/protocol` |
| **Proof** | Evidence, audits, case studies, references | `/proof` |
| **Status** | Facework's own coherence tracker | `/status` |
| **Engage** | Commercial entry point | `/engage` |

**Why `System` instead of `Protocol`:**
- The page is already carrying more than protocol mechanics.
- The layered model includes theory, discipline, practice, and conformance.
- "Protocol" is too narrow for the public job of this page.

### Page-by-page role map

| Page | Public job | Visitor question it answers |
|------|------------|-----------------------------|
| **Home** | Orient and qualify | "What is this, and why does it matter?" |
| **System** | Explain the stack | "How does this worldview become a buildable practice?" |
| **Proof** | Demonstrate evidence | "Has this produced real systems?" |
| **Status** | Show self-application | "Does Facework submit itself to the same standards?" |
| **Engage** | Convert fit into contact | "Is this for me, and how would we work together?" |
| **Deep Read** | Let serious readers study | "Can I inspect the underlying logic directly?" |

### Content sequencing rule

The site should move from **meaning** to **method** to **evidence** to
**engagement**.

That means:

- Home should not try to teach every document.
- System should not feel like a dump of repo categories.
- Engage should not carry the burden of explaining theory.
- Proof should demonstrate consequence, not just artifact counts.

### Home page structure (vNext)

The home page should stage the public narrative in this order:

1. **Claim:** Facework turns cultural signal into coherent, ownable systems
2. **Problem:** energy is extracted when creators do not control infrastructure
3. **Layer model:** theory → discipline → practice → proof
4. **What the practice produces:** governance, direction, architecture, prototype
5. **Non-negotiables:** sovereignty, openness, no lock-in
6. **Call to action:** read the system / engage

This adds one missing move to the current homepage: an explicit explanation of
where Facework sits in the stack.

### System page structure (vNext)

The current "Protocol" page groups docs by repo-flavored categories. The public
page should instead stage the layered model:
...
3. **Practice**
   - Constitution
   - Facework Protocol
   - Postures / operating layer
4. **Conformance / governance**
   - Conformance model
   - Status of the standards track

This page should answer: "How do these layers relate?" not merely "Which docs
exist?"

### Proof page structure (vNext)

Proof should demonstrate consequence in descending order of trust:

1. Named systems / projects
2. What changed structurally
3. Conformance / extraction check result
4. Artifacts produced
5. Date / stage / status

Artifact counts matter, but they should support the proof narrative, not carry
it.

### Engage page structure (vNext)

Engage should read as the **commercial expression of the practice**, not as a
generic agency CTA.

The sequence should be:

1. Who this is for
2. What shift Facework creates
3. How engagements are structured
4. What a client leaves with
5. Qualification boundary
6. Contact

This is especially important if the public site becomes more explicit about the
layer model. The Engage page is where the practice becomes legible as a service
without collapsing into "services site" language.

### Deep Read rule

Deep-read pages should remain sparse, document-like, and slower than the rest
of the site. They are for conviction, not conversion.

### IA anti-patterns

Do not:

- treat "Facework" and "the protocol" as perfect synonyms on every page
- merge theory and offer into the same paragraph without signaling the shift
- make proof pages look like portfolio marketing
- make engage pages carry worldview explanation that belongs on Home or System
- expose repo structure as if it were user-facing IA

---

## 3A. INFORMATION ARCHITECTURE — Page-by-Page Artboards
...
```
┌─────────────────────────────────────────────────────────────┐
│ NAV: face.works    System  Proof  Status  Engage            │
...
│                                                             │
│  WHERE FACEWORK SITS                                        │
│  Cultural Physics  →  Coherence Design                      │
│  →  Facework  →  Proof ventures                             │
│                                                             │
│  Theory explains. Discipline designs.                       │
│  Practice applies. Proof demonstrates.                      │
│                                                             │
├─────────────────────────── hr ──────────────────────────────┤
│                                                             │
...
│         [Read the system]  [Work with Facework]             │
│                                                             │
├─────────────────────────────────────────────────────────────┤
│ FOOTER: CONTROL THE CURRENT.     Facework System / Protocol v2│
└─────────────────────────────────────────────────────────────┘
...
LAYOUT: Single-column narrative with an inserted layer-model section before
"what the practice produces"
```

### Artboard 2: SYSTEM — "The Coherence Stack"
...
│                                                             │
│  The System                                                 │
│  How the worldview becomes a practice.                      │
│                                                             │
│  THEORY                                                     │
│  ┌─────────────────────────────────────────────────────┐   │
...
│  ├─────────────────────────────────────────────────────┤   │
│  │ Coherence Design                                    │   │
│  │ The discipline of designing coherent systems        │   │
│  └─────────────────────────────────────────────────────┘   │
│                                                             │
│  PRACTICE                                                   │
│  ┌─────────────────────────────────────────────────────┐   │
...
│  │ Constitution / Postures / Operating logic           │   │
│  └─────────────────────────────────────────────────────┘   │
│                                                             │
...
│  └─────────────────────────────────────────────────────┘   │
│                                                             │
│  FUTURE: Interactive layer map                              │
│  Hover a layer → see its job and its outputs                │
│  Click → enter the deep read                                │
│                                                             │
└─────────────────────────────────────────────────────────────┘

ENGINE: Strategy Engine (Frequency + Current)
FEELING: "This is a layered system, not just a spec archive."
ACTIVE PRIMITIVE: Frequency
LAYOUT: Single-column, stacked layer groups in dependency order
FUTURE STATE: Interactive layer map where docs live inside a visible stack
```
...
│  ┃ Exit criteria:                                           │
│  ┃ ◐ Revenue $5K+/month × 3                               │
│  ┃ ◐ 3 practice runs + 1 public reference                  │
│  │                                                          │
...
│  ENGAGEMENT TYPES                                           │
│  ┌──────────────────┐ ┌──────────────────┐                 │
│  │ Full System Build│ │ Foundation Layer │                 │
│  │ 5-8 days         │ │ 3-5 days         │                 │
│  │ $15K-$25K        │ │ $10K-$15K        │                 │
│  └──────────────────┘ └──────────────────┘                 │
│                                                             │
...
| Markdown | System deep-read rendering | Handles headings, code blocks, tables, lists, blockquotes |
| Footer | Tagline + version | xs text, uppercase tagline, system/protocol version |
